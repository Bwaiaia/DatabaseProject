                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employees.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="training_type" id="training_type" value="{{ old('training_type', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="training_provid" id="training_provid" value="{{ old('training_provid', '') }}" required>
                            @if($errors->has('training_provid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('training_provid') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="training_ini" id="training_ini" value="{{ old('training_ini') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="training_end" id="training_end" value="{{ old('training_end') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="training_dur" id="training_dur" value="{{ old('training_dur', '') }}" required>
