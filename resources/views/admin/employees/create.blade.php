    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_type') ? 'is-invalid' : '' }}" type="text" name="training_type" id="training_type" value="{{ old('training_type', '') }}" required>
            ...
            <div class="form-group">
                <label class="required" for="training_provid">{{ trans('cruds.employee.fields.training_provid') }}</label>
                <input class="form-control {{ $errors->has('training_provid') ? 'is-invalid' : '' }}" type="text" name="training_provid" id="training_provid" value="{{ old('training_provid', '') }}" required>
                @if($errors->has('training_provid'))
                    <span class="text-danger">{{ $errors->first('training_provid') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.employee.fields.training_provid_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="training_ini">{{ trans('cruds.employee.fields.training_ini') }}</label>
                <input class="form-control date {{ $errors->has('training_ini') ? 'is-invalid' : '' }}" type="text" name="training_ini" id="training_ini" value="{{ old('training_ini') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('training_end') ? 'is-invalid' : '' }}" type="text" name="training_end" id="training_end" value="{{ old('training_end') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_dur') ? 'is-invalid' : '' }}" type="text" name="training_dur" id="training_dur" value="{{ old('training_dur', '') }}" required>
